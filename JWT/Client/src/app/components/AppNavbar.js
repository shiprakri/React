...
class AppNavbar extends Component {
  constructor(props) {
    ...
    this.toggle = this.toggle.bind(this);//toggle is used for show and hide selected method, for visibility,bind is used for callback
  ...
  componentDidMount() //componentDidMount() method is called after the component is rendered
  {
    ...
    if (user) {
      ...
      this.setState({
        ...
        login: true,
        username: user.accessToken.username 
